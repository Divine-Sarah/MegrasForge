  ...
  return (
    <main className="w-full mt-5 ">
      <aside className="sidebar">
        <div className="fixed top-0 z-20 w-1/2 h-screen p-2 duration-200 ease-out delay-150 bg-[#EDDDFA] -left-96 lg:w-60 lg:left-0 peer-focus:left-0 peer:transition">
          <div className="flex flex-col items-center justify-start">
            <div className="flex justify-center mx-auto">
              {/* < FaMediumM  size={50}/> */}
              <h1 className="w-full pb-4 text-base font-bold text-center border-b border-[#BA80E6] cursor-pointer text-[#391952]">
                MegrasForge
              </h1>
            </div>
